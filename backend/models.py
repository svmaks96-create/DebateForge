...
class Debate(Base):
    ...
    enable_search: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    enable_verification: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
